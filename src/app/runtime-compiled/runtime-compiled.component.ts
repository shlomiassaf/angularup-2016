import { Component, Compiler, NgModuleRef, ComponentFactoryResolver } from '@angular/core';
...
export class RuntimeCompiledComponent {
  ...
  constructor(private dialogRef: DialogRef<any>, private compiler: Compiler, private modal: Modal, private c: ComponentFactoryResolver) {
    console.log(c);
  }
